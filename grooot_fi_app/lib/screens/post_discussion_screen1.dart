...
class PostDiscussionScreen1 extends StatefulWidget {
  ...
  @override
  State<PostDiscussionScreen1> createState() => _PostDiscussionScreen1State();
}

class _PostDiscussionScreen1State extends State<PostDiscussionScreen1> {
...
// Method to reset the selected category
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            PostDiscussionDescribePostTextbox(
              postDescriptionController: widget.postDescriptionController,
            ),
          ],
        ),
      ),
